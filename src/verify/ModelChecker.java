...
public class ModelChecker {
	 ...
	 * @throws Exception
	 */
	public String invokeModelChecker(String command, String smvFileName, String specFileName, String voFile) throws Exception {
		...
		for (int i = 0; i < smvFiles.length; i++) {
			outputFiles[i] = invokeModelChecker(command, smvFiles[i], voFile);
		}
		...
		WorkingPreferenceModel.getPrefMetaData().setOutputFile(formattedOutputFileName);
	 ...
	 * @throws Exception
	 */
	public String invokeModelChecker(String command, String smvFile, String voFile) throws Exception {
		...
		outputFile = WorkingPreferenceModel.getPrefMetaData().getOutputFile(); 
