...
public interface TraceFormatter {
	...
	/**
	 * Parses a String array representing a state in the model (preference namesOfVariables and change namesOfVariables)  from the trace generated by the model checker
	 * @param pmd
